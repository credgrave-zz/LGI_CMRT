...
def parseWriteDittoAvailability(infile_json, outfile_path, ditto_country, ditto_date):
	...
	for record in json_file[u'TVA_ScheduleEventTable']:
		...
		try:
			...
			OESP_csv_row.append('OESP')
			OESP_csv_row.append(record[u'ScheduleEvent'][u'Program'][u'crid'])
			OESP_csv_row.append(record[u'_OESP'][u'request'])
			OESP_csv_row.append(record[u'_OESP'][u'available'][u'requestTime'])
			OESP_csv_row.append('')
			OESP_csv_row.append(record[u'_OESP'][u'available'][u'exists'])
			OESP_csv_row.append(record[u'_OESP'][u'AvailabilityTime'])
			OESP_csv_row.append('')
			OESP_csv_row.append('linear')
			OESP_csv_row.append(ditto_country)
			OESP_csv_row.append(ditto_date)

			writer.writerow(OESP_csv_row)
			OESP_csv_row = []

			#OESP Data
			CMDC_csv_row = []

			CMDC_csv_row.append('CMDC')
			CMDC_csv_row.append(record[u'ScheduleEvent'][u'Program'][u'crid'])
			CMDC_csv_row.append(record[u'_CMDC'][u'request'])
			CMDC_csv_row.append(record[u'_CMDC'][u'available'][u'requestTime'])
			CMDC_csv_row.append('')
			CMDC_csv_row.append(record[u'_CMDC'][u'available'][u'exists'])
			CMDC_csv_row.append(record[u'_CMDC'][u'AvailabilityTime'])
			CMDC_csv_row.append('')
			...
			RENG_csv_row.append('RENG')
			RENG_csv_row.append(record[u'ScheduleEvent'][u'Program'][u'crid'])
			RENG_csv_row.append(record[u'_RENG'][u'request'])
			RENG_csv_row.append(record[u'_RENG'][u'available'][u'requestTime'])
			RENG_csv_row.append('')
			RENG_csv_row.append(record[u'_RENG'][u'available'][u'exists'])
