	...
	python parseScheduleOnly.py ${local_data}/${country}/TVA_${country}_${process_date}.xml $local_data $country $process_date 
...
sftp cmrt@172.16.78.38 <<< "put $local_data/CMRT_content_schedule_${country}_${process_date}.csv"
